...
<body>
	<form:form  id="form1" name="form1" action="${pageContext.request.contextPath}/ccp/doAdd.do"
		...
		<table>
		    <tr>
			<th>危害分析ID</th>
				<td><input type="text" id="haId"  name="haId" value="${ccp.haId}"
					readonly>
					<input id="openWin" name="openWin" type="button" value="選取"></td>
					<td><input type="text" id="procStep" name="procStep" value="${ccp.ha.procStep}" readonly></td>
					<td><input type="text" id="planId" name="planId" value=$ha.planId}"  readonly></td>					
			</tr>
			<tr>
			<th>Q1</th>
			<th>Q2</th>
