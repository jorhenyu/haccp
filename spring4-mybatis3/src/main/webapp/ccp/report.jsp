...
$(document).ready(function() {  
	...
	$("#exportWord").click(function(){
		   var method =$("input[name='ccpplanId']:checked").val(); //radio 取值，注意寫法
...
<body>
	<table>
		<tr>
			...
			<form id="myForm" name="myForm" action="${pageContext.request.contextPath }/ccp/exportExcel.do" method="post">
		...
		<c:forEach var="ccp" items="${lsts}">
			<tr><td>
					<input type="radio" id="ccpplanId" name="ccpplanId" value="${ccp.planId}">
				</td>
